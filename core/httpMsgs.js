...
exports.showHome = function (req, resp) {
    if (settings.httpMsgsFormat === "HTML") {
        ...
        resp.write("<html><html><head><title>Home</title></head><body>Valid endpoints:<br> /cameras - GET - To List all cameras</body></html>");
    } else {
        resp.writeHead(200, "Valid EndPoints", { "Content-Type": "application/json" });
        resp.write(JSON.stringify([{ url: "/cameras", operation: "GET", description: "To List all cameras" }]));
    }
